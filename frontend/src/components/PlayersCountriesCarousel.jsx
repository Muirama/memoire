    ...
    case "south-africa":
      return (
        ...
        >
          ...
          <polygon
            points="0,0 5,2.7 12,2.7 12,5.3 5,5.3 0,8 0,6.2 3.2,4 0,1.8"
            fill="#FFFFFF"
          />
          <polygon
            points="0,0.6 4.3,2.95 12,2.95 12,5.05 4.3,5.05 0,7.4 0,5.9 2.7,4 0,2.1"
            fill="#007A4D"
          />
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="mt-4 max-w-3xl mx-auto text-sm md:text-base text-gray-300 leading-relaxed">
            Une communaute connectee entre l'ocean Indien, l'Afrique et
            l'Europe.
          </p>
        </motion.div>
              ...
              <div className="relative h-full rounded-[26px] border border-white/8 bg-[#121212]/92 p-5 md:p-6 overflow-hidden shadow-[0_0_24px_rgba(229,9,20,0.08)] transition-all duration-300 hover:-translate-y-1 hover:border-[#E50914]/35 hover:shadow-[0_0_30px_rgba(229,9,20,0.2)]">
                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-3 text-sm text-gray-400 leading-relaxed"></p>
                  </div>
                </div>
              </div>
            </SwiperSlide>
